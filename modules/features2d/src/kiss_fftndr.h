...
kiss_fftndr_cfg kiss_fftndr_alloc(const int *dims, int ndims, int inverse_fft,
...
void kiss_fftndr(kiss_fftndr_cfg cfg, const kiss_fft_scalar *timedata,
...
void kiss_fftndri(kiss_fftndr_cfg cfg, const kiss_fft_cpx *freqdata,
